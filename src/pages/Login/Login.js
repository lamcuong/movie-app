                ...
                <div className="mt-12">
                    <div>
                      ...
                      cursor-pointer">
                            ...
                            <input onChange={formik.handleChange} name='matKhau' className="w-full border-x-0 border-t-0 text-lg py-2 border-b focus:ring-0 border-gray-300  focus:outline-none focus:border-indigo-500" type='text' placeholder="Nhập mật khẩu" />
